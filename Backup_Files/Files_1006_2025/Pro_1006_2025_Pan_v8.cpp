...
void multiProcess(Mat imgArr[][2]) {
    ...
    errno_t err = fopen_s(&fl_fValue, "./imgs_1006_2025_v7/output/f_value.txt", "w");
    ...
    errno_t err2 = fopen_s(&fl_maxFval, "./imgs_1006_2025_v7/output/maxFvalInfo_final.txt", "w");
    if (err2 != 0 || fl_maxFval == nullptr) {
        perror("Cannot open the file");
    }

    FILE* fl_printTree = nullptr;
    errno_t err3 = fopen_s(&fl_printTree, "./imgs_1006_2025_v7/output/printed_tree.txt", "w");
...
int main(void) {
    ...
    if (numSets == 1) {
        sprintf_s(inputPathName_ori, "./imgs_1006_2025_v7/input/oriImg_0%d.png", idSet);
        sprintf_s(inputPathName_tar, "./imgs_1006_2025_v7/input/tarImg_0%d.png", idSet);
        imgArr[0][0] = imread(inputPathName_ori, 0);
        imgArr[0][1] = imread(inputPathName_tar, 0);
    }
    else {
        for (int i = 0; i < numSets; i++) {
            sprintf_s(inputPathName_ori, "./imgs_1006_2025_v7/input/oriImg_0%d.png", i + 1);
            sprintf_s(inputPathName_tar, "./imgs_1006_2025_v7/input/tarImg_0%d.png", i + 1);
