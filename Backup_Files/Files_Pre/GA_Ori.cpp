...
int main(int argc, char *argv[])
{
	...
	if (picture_loading_mode == 0)
	{
		...
		imwrite("originout_before.jpg", img1_before);
		imwrite("targetout_before.jpg", img2_before);
	}
	else
	{
		img1 = imread("originout_before.jpg");
		img2 = imread("targetout_before.jpg");
		cvtColor(img1, img1ths, COLOR_RGB2GRAY);
		if (img1.empty())
		{
			printf("画像を読み込みできない");
