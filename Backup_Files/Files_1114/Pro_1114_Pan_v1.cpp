...
void singleProcess(Mat oriImg_g, Mat tarImg, Mat maskImg, int num_img) {
    ...
    sprintf_s(paramAddName, "./imgs_1114_v1/output/img_0%d/params.txt", num_img);
    ...
    for (int numGen = 1; numGen <= num_gen; numGen++) {
        ...
        if (numGen % 10 == 0) {
            sprintf_s(imgName_pro, "./imgs_1114_v1/output/img_0%d/Gen-%d.png", num_img, numGen);
    ...
    hconcat(images, res);
    // imgShow("res_p1", res);
    sprintf_s(imgName_final, "./imgs_1114_v1/output/img_0%d/imgs_final.png", num_img);
...
int main(void) {
    ...
    for (int i = 0; i < 5; i++) {
        sprintf_s(inputPathName_ori, "./imgs_1114_v1/input/oriImg_0%d.png", i + 1);
        sprintf_s(inputPathName_tar, "./imgs_1114_v1/input/tarImg_0%d.png", i + 1);
        if (i == 1) {
            sprintf_s(inputPathName_mask, "./imgs_1114_v1/input/maskImg_02.png");
        }
        else {
            sprintf_s(inputPathName_mask, "./imgs_1114_v1/input/maskImg_general.png");
        }
        for (int j = 0; j < 3; j++) {
            if (j == 0) {
