...
int main(void) {
    ...
    errno_t err = fopen_s(&fl_evaluation, "./imgs_0605_2026_v2/output/test/evaluation.txt", "a");
    ...
    auto eliteTree = loadTreeFromFile("./imgs_0605_2026_v2/input/test/elite_tree_gp/printed_tree_sys.txt");
    if (!eliteTree) {
    ...
    for (int i = 11;i <= 110;i++) {
        char imgName[256];
        char gtName[256];
        sprintf_s(imgName, "./imgs_0605_2026_v2/input/test/images/crack_%05d.png", i);
        sprintf_s(gtName, "./imgs_0605_2026_v2/input/test/masks/crack_%05d.png", i);
        ...
        gres.download(pred);
        char outName[256];
        sprintf_s(outName, "./imgs_0605_2026_v2/output/test/resImgs/res_%05d.png", i);
