...
#define tempMax 0.9 // this value would be compared with all the f1_values, better values would be writed
...
int main(void) {
    FILE* file = nullptr;
    errno_t err = fopen_s(&file, "./imgs_0114_v1/output/Output_BestCase.txt", "a");
    ...
    for (int i = 0; i < numSets; i++) {
        //sprintf_s(inputPathName_ori, "./imgs_0114_v1/input/oriImg_0%d.png", i + 1);
        //sprintf_s(inputPathName_tar, "./imgs_0114_v1/input/tarImg_0%d.png", i + 1);

        sprintf_s(inputPathName_ori, "./imgs_0114_v1/input/oriImg_01.png");
        sprintf_s(inputPathName_tar, "./imgs_0114_v1/input/tarImg_01.png");
        sprintf_s(inputPathName_mask, "./imgs_0114_v1/input/maskImg_general.png");
    ...
    for (int caseIdx = 0; count; caseIdx++) {
