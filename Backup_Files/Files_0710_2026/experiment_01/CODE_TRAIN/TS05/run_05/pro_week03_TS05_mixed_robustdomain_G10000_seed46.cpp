...
static_assert(TRAIN_SIZE == 5, "This mixed-set source file expects TRAIN_SIZE=5.");
...
#ifndef GENERATIONS
#define GENERATIONS 10000 // Week-03 TS05 mixed-robustdomain formal run
#endif
...
#define WEEK03_OUTPUT_PREFIX "week03_TS05_mixed_robustdomain_GP_G10000_seed" STR(RANDOM_SEED)
#endif
...
#if USE_ROBUST_DOMAIN_FITNESS
    // Stronger validation objective for mixed thin/thick TS05:
